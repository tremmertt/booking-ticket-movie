...
export default function Footer(props) {
  ...
  const arrCineSystem = _.map(cineSystem, (cineSystem) =>
    _.pick(cineSystem, ["maHeThongRap", "tenHeThongRap", "logo"])
  );

  console.log("arr", arrCineSystem);
  return (
    <footer className="py-6 bg-coolGray-100 text-coolGray-900 bg-gray-500">
        ...
        <div className="grid grid-cols-12">
          <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
            ...
            <div className="text-center xl:text-left ">
              <p className="pb-1 font-medium mt-12 text-xl">CONTACT</p>
              <div
                className="grid grid-cols-2 text-base"
                style={{ color: "#fff" }}
              >
                <h3> Email: </h3>
                <p className="font-light"> movieticket@gmail.com </p>

                <h3> Address: </h3>
                <p className="font-light">
                  {" "}
                  220 Cong Hoa, Ward 12, Tan Binh, HCMC{" "}
                </p>

                <h3> Telephone: </h3>
                <p className="font-light"> 028.7300.2266 </p>

                <h3> Hotline: </h3>
                <p className="font-light"> 0933.108.554 | 0971.294.545 </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-3">
            ...
            <div className="grid grid-cols-3" style={{ color: "#fff" }}>
              {arrCineSystem.map((cn, index) => {
                return (
                  <div key={index}>
                    <img src={cn.logo} style={{ width: 50 }} className="mt-2" />
                  </div>
                );
              })}
            </div>
